...
private:
  ...
  static void laser_cycle(AxisEnum AxisXY,AxisEnum AxisZ, float dist, float z, float feedrate,float* xy_dhm);
  static void laser_cycle_one_Axis(AxisEnum AxisXY, int8_t disp,float distXY, float distZ,float feedrate);
  static void  laser_calibrate_disp(int8_t disp,float distXY, float distZ,float feedrate);
  static void laser_calibrate_start_move(int8_t disp);
