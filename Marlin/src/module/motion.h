...
void do_homing_move(AxisEnum axis, float distance, feedRate_t fr_mm_s,  bool final_approach);
void do_homing_move_laser(AxisEnum axis, float distance, feedRate_t fr_mm_s,  bool final_approach);
 ...
 */
  ...
  #endif
  extern xyz_pos_t petry_shift;

  extern xyz_pos_t home_offset_Z;
  extern xyz_pos_t home_offset_A;
  extern xyz_pos_t home_offset_B;
  ...
  extern xyz_pos_t workspace_offset_Z;
  extern xyz_pos_t workspace_offset_A;
  extern xyz_pos_t workspace_offset_B;
