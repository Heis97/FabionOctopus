...
void Stepper::init() {
  ...
  float petry_z = -12.21;
  petry_shift[X_AXIS] = 67.76; 
  petry_shift[Y_AXIS] = 73.24;
  petry_shift[Z_AXIS] = petry_z;
  petry_shift[I_AXIS] = petry_z;
  petry_shift[J_AXIS] = petry_z; 

  position_shift_Z[X_AXIS] = 0; position_shift_Z[Y_AXIS] = 0; position_shift_Z[Z_AXIS] = 0;
  position_shift_A[X_AXIS] = 0; position_shift_A[Y_AXIS] = 0; position_shift_A[I_AXIS] = 0;
  position_shift_B[X_AXIS] = 0; position_shift_B[Y_AXIS] = 0; position_shift_B[J_AXIS] = 0;

  home_offset_Z[X_AXIS] = 92;   home_offset_Z[Y_AXIS] = 30;  home_offset_Z[Z_AXIS] = -100;
  home_offset_A[X_AXIS] = 158;  home_offset_A[Y_AXIS] = 30;  home_offset_A[I_AXIS] = -100;
  home_offset_B[X_AXIS] = 26;   home_offset_B[Y_AXIS] = 30;  home_offset_B[J_AXIS] = -100;

  workspace_offset_Z[X_AXIS] = 0;  workspace_offset_Z[Y_AXIS] = 0;  workspace_offset_Z[Z_AXIS] = 0;
  workspace_offset_A[X_AXIS] = 0; workspace_offset_A[Y_AXIS] = 0;  workspace_offset_A[I_AXIS] = 0;
  workspace_offset_B[X_AXIS] = 0;  workspace_offset_B[Y_AXIS] = 0;  workspace_offset_B[J_AXIS] = 0;

  update_workspace_offset_Z(0);
  update_workspace_offset_Z(1);
  update_workspace_offset_Z(2);
